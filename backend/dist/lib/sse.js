 ...
 */
function emitExecutionEvent(executionId, type, data) {
    const event = {
        type,
    ...
    console.log(`[sse] Emitted "${type}" for execution ${executionId.slice(0, 8)}`);
}
/**
 ...
 */
function subscribeToExecution(executionId, subscriber) {
